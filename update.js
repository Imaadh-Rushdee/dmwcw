function doValidation()
{
    ...
    var grade = document.forms["update"]["cg"].value;
    var age = document.forms["update"]["ag"].value;
    var mcontact = document.forms["update"]["mc"].value;
    var fcontact = document.forms["update"]["fc"].value;
    var fathername = document.forms["update"]["fgn"].value;
